...
namespace RestaurantMS
{
    public partial class ViewgeneratedInvoice : Form
    {
        ...
        private void ViewgeneratedInvoice_Load(object sender, EventArgs e)
        {
            ...
            string sql2 = "select invo_no AS InvoiceNO, cust_id AS CustomerID, ord_no AS OrderNO, invo_date AS Date,ISNULL(deal_name,'NULL') As DealName, noOfDeals As NoOfDeals, amount AS Amount from invoice where cust_id = '" + custno + "'";
